        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm leading-relaxed">
              UFO9 is a popular online casino in Malaysia and slot game platform that offers a wide range of games, including slot games, table games, and arcade games.
            </p>
          </div>
