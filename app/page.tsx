...
export const metadata: Metadata = {
  title:
    "SPACE9 Casino - Australia's No.1 Online Casino & Pokies Guide | iOS & Android",
  description:
    "Australia's trusted online casino with expert pokies guides & winning strategies. Play slots, live dealer games, sports betting. Download SPACE9 on iOS & Android. 24/7 support, PayID deposits.",
  keywords:
      ...
      <section className="bg-gradient-to-b from-slate-100 to-white py-16 md:py-24">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <p className="text-gray-700 text-center mb-12 text-lg">
            Learn from our expert guides to improve your gaming strategy and
            maximize wins at SPACE9
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
            ...
            >
              ...
              <p className="text-gray-700 mb-4">
                Master the art of selecting pokies with the best Return to
                Player percentages to maximize your winnings.
              </p>
            ...
            >
              ...
              <p className="text-gray-700 mb-4">
                Learn proven techniques to manage your casino budget effectively
                and extend your playing sessions.
              </p>
              <span className="text-amber-600 font-semibold hover:text-amber-700">
                Read Guide →
              </span>
            ...
            >
              <h3 className="text-xl font-bold text-slate-900 mb-3">
                Live Blackjack Winning Tips
              </h3>
              <p className="text-gray-700 mb-4">
                Discover professional strategies for live dealer blackjack
                including basic strategy and card counting basics.
              </p>
              <span className="text-amber-600 font-semibold hover:text-amber-700">
                Read Guide →
              </span>
            ...
            >
              ...
              <p className="text-gray-700 mb-4">
                Understand how to maximize free spins and bonus features for
                bigger payouts on SPACE9 pokies.
              </p>
              <span className="text-amber-600 font-semibold hover:text-amber-700">
                Read Guide →
              </span>
            ...
            >
              ...
              <p className="text-gray-700 mb-4">
                Learn comprehensive strategies to maximize your winning
                potential and reduce losses at any online casino.
              </p>
              <span className="text-amber-600 font-semibold hover:text-amber-700">
                Read Guide →
              </span>
            ...
            >
              ...
              <p className="text-gray-700 mb-4">
                Learn how to read betting odds, conduct research, and make
                informed sports betting decisions at SPACE9.
              </p>
              <span className="text-amber-600 font-semibold hover:text-amber-700">
                Read Guide →
              </span>
