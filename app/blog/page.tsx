...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "SPACE9 Casino Blog - Expert Tips & Strategies",
    description:
      "Discover expert tips, winning strategies, and comprehensive guides for pokies, live casino, and sports betting.",
