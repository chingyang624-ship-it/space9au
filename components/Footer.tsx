      ...
      <div style={{ maxWidth: "1087px" }} className="mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          <div>
            ...
            <p className="text-gray-400 text-sm leading-relaxed">
              SPACE9 is a popular online casino in Australia and slot game
              platform that offers a wide range of games, including slot games,
              table games, and arcade games.
            </p>
          </div>
        ...
        <div className="border-t border-gray-700 pt-8 text-center">
          ...
          <p className="text-gray-600 text-xs mt-4">
            SPACE9 Casino is licensed and regulated. Players must be 18+ to
            participate. Please gamble responsibly.
          </p>
        </div>
      </div>
    </footer>
